...
def train():
    ...
    # for param in medusa_lm_head.fast_layer1.parameters():
    #     param.requires_grad = True
    # for param in medusa_lm_head.fast_layer2.parameters():
    #     param.requires_grad = True
    #model_name = '../model/medusa_8_1_token'  #medusa'
    # mduModel =  SingleMedusa(model=model , medusa_head_name_or_path =model_name)
    #########加载旧模型头#########
    # medusa_lm_head = MedusaModel.from_pretrained('./231119_medusa_mlp_vicuna-7b-v1.3_medusa_3_lr_0.001_layers_2',
    ...
    #######加载checkpoint#####
    # trimlp = torch.load('./idea5_3gram_4fastlayer_t1_skipbert_teacherstudent_medusa_mlp_vicuna-7b-v1.3_medusa_1_lr_0.0002_layers_1/trimlp.pt')
    # medusa_lm_head.trimlp.load_state_dict(trimlp)
    # fastlayer1 = torch.load('./idea5_3gram_4fastlayer_t1_skipbert_teacherstudent_medusa_mlp_vicuna-7b-v1.3_medusa_1_lr_0.0002_layers_1/fastlayer1.pt')
    # medusa_lm_head.fast_layer1.load_state_dict(fastlayer1)
    # fastlayer2 = torch.load('./idea5_3gram_4fastlayer_t1_skipbert_teacherstudent_medusa_mlp_vicuna-7b-v1.3_medusa_1_lr_0.0002_layers_1/fastlayer2.pt')
    # medusa_lm_head.fast_layer2.load_state_dict(fastlayer2)
    # fastlayer3 = torch.load('./idea5_3gram_4fastlayer_t1_skipbert_teacherstudent_medusa_mlp_vicuna-7b-v1.3_medusa_1_lr_0.0002_layers_1/fastlayer3.pt')
    # medusa_lm_head.fast_layer3.load_state_dict(fastlayer3)
    # fastlayer4 = torch.load('./idea5_3gram_4fastlayer_t1_skipbert_teacherstudent_medusa_mlp_vicuna-7b-v1.3_medusa_1_lr_0.0002_layers_1/fastlayer4.pt')
    # medusa_lm_head.fast_layer4.load_state_dict(fastlayer4)
    ...
    # torch.save(
    #     medusa_lm_head.fast_layer1.state_dict(),
    #     os.path.join(training_args.output_dir, "fastlayer4.pt"),
    #)
